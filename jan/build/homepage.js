(function(){
    ...
    HomePage.prototype.preshow = function(){
        this.$el.append(Mustache.render(app.templates.homepage,{}));
        addBanner.call(this);
    ...
    function addBanner(){
        ...
        this.banner = $(Mustache.render(app.templates.banner,content));
        this.$el.find('.banner').append(this.banner);
    }


    function addMasthead(){
        this.masthead = $(Mustache.render(app.templates.masthead,{}));
        this.$el.find('.masthead').append(this.masthead);
    }

    function addCarousel(){
        this.quickregistration = $(Mustache.render(app.templates.quickregistration,{}));
        ...
        var $processButtonDropcard = $(Mustache.render(app.templates.dropcard,processContent));
        $processButton.append($processButtonDropcard);

        var $firmButtonDropcard = $(Mustache.render(app.templates.dropcard,firmcontent));
    ...
    function addCards(){
        ...
        for(var i=0;i<10;i++){
            var $card = $(Mustache.render(app.templates.processcard,dataP));
        ...
        for(var i=0;i<10;i++){
            var $fcard = $(Mustache.render(app.templates.firmcard,dataF));
